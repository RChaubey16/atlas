...
export class AuthProxyController {
  ...
  @ApiOperation({
    ...
    description:
      'Pass ?redirect=https://links.ruturaj.xyz to control where the browser lands after auth.',
  })
  @ApiResponse({
    status: 302,
  ...
  @ApiOperation({
    summary:
      'Google OAuth callback — sets auth cookies and redirects to frontend',
  })
  @ApiResponse({
    status: 302,
    description: 'Redirects to the frontend with auth cookies set',
  })
  @UseGuards(GoogleAuthGuard)
  @Get('google/callback')
